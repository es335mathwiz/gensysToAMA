...
delete t_lag2_checka.log;
warning on;
warning backtrace;
logname_ = 't_lag2_checka.log';
diary 't_lag2_checka.log';
erase_compiled_function('t_lag2_checka_static');
erase_compiled_function('t_lag2_checka_dynamic');
M_.exo_names = 'e';
M_.exo_names_tex = '';
...
save('t_lag2_checka_results', 'oo_');
diary off
