function [G1,C,impact,fmat,fwt,ywt,gev,eu]=gensys2007(g0,g1,c,psi,pi,div)
% function [G1,C,impact,fmat,fwt,ywt,gev,eu]=gensys2007(g0,g1,c,psi,pi,div)
% frozen copy of gensys for gensysToAMA
%for use in case gensys not found on user path
% System given as
...
nunstab;
if ~zxz
%alejandro indicates ordqz faster   [a b q z]=qzdiv2007(div,a,b,q,z);
[a b q z]=qzdiv2007(div,a,b,q,z);
%   [a b q z]=ordqz(div,a,b,q,z);
end
gev=[diag(a) diag(b)];
if zxz
