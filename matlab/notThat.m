...
delete test_matlab.log;
warning on;
warning backtrace;
logname_ = 'test_matlab.log';
diary 'test_matlab.log';
erase_compiled_function('test_matlab_static');
erase_compiled_function('test_matlab_dynamic');
M_.exo_names = 'e';
M_.exo_names_tex = '';
...
oo_.steady_state( 5 ) = 0.1;
oo_.steady_state( 3 ) = 11;
