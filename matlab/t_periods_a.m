...
delete t_periods_a.log;
warning on;
warning backtrace;
logname_ = 't_periods_a.log';
diary 't_periods_a.log';
erase_compiled_function('t_periods_a_static');
erase_compiled_function('t_periods_a_dynamic');
M_.exo_names = 'x';
M_.exo_names_tex = '';
M_.endo_names = 'c';
M_.endo_names_tex = '';
...
oo_.steady_state( 1 ) = (((M_.params(5)*(oo_.steady_state(2)^M_.params(1)))-(M_.params(3)*oo_.steady_state(2)))+1);
