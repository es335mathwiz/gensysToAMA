function [residual, g1, g2] = t_periods_dynamic(y, x)
% 
...
T1330404440 = exp(y(7))*y(2)^params(3);
...
T1330404514 = (-(T1330404441*exp(y(7))*params(3)*y(2)^(params(3)-1.0)));
...
if nargout >= 3,
  ...
  g2(3, 21) = T1330404514;
  g2(3, 16) = (-(T1330404441*exp(y(7))*params(3)*(params(3)-1.0)*y(2)^(params(3)-1.0-1.0)));
  g2(4, 117) = exp(y(9));
  g2(4, 116) = (-exp(y(9)));
